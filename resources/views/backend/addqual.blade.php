        ...
        <div class="row">
          ...
          <div class="col-md-12" style="padding-right: 250px">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="{{ url('addqual') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="qualtitle" >
                </div>
                <div class="form-group">
                    <label for="qualdesc"> Description</label>
                    <input type="text" class="form-control" name="qualdesc" >
                </div>
                    <div class="form-group">
