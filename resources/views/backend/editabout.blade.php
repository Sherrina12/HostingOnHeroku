            ...
            <div class="card card-primary">
              ...
              <form action="{{ url('updateabout/'.$about->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="aboutdesc" value="{{ $about->aboutdesc}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="age" value="{{ $about->age}}">
                </div>
                <div class="form-group">
                    <label for="location"> Location </label>
                    <input type="text" class="form-control" name="location" value="{{ $about->location}}">
                </div>
                <div class="form-group">
                    ...
                    <img src="{{ asset('assets/img/'.$about->aboutimg) }}" width="70px" height="70px" alt="Image">
                </div>
                <!-- /.card-body -->
