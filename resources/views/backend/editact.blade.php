        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-8">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/adminact">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12" style="padding-right: 250px">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="{{ url('updateact/'.$activity->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                <div class="form-group">
                    <label for="actdesc"> Description</label>
                    <input type="text" class="form-control" name="actdesc" value="{{ $activity->actdesc}}">
                </div>
                    <div class="form-group">
                    ...
                    <img src="{{ asset('assets/img/'.$activity->actimg) }}" width="70px" height="70px" alt="Image">
                </div>
                <!-- /.card-body -->
