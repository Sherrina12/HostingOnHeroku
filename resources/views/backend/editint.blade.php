        ...
        <div class="row">
          ...
          <div class="col-md-12" style="padding-right: 250px">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="{{ url('updateint/'.$interest->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <img src="{{ asset('assets/img/'.$interest->intimg) }}" width="250px" height="250px" alt="Image">
                </div>
                <!-- /.card-body -->
