        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-8">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/adminqual">Home</a></li>
          ...
          <div class="col-md-12" style="padding-right: 250px">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">My Qualification</h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form action="{{ url('updatequal/'.$qualification->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">

                  <div class="form-group">
                    <label for="qualtitle"> Title</label>
                    <input type="text" class="form-control" name="qualtitle" value="{{ $qualification->qualtitle}}">
                </div>
                <div class="form-group">
                    <label for="qualdesc"> Description</label>
                    <input type="text" class="form-control" name="qualdesc" value="{{ $qualification->qualdesc}}">
                </div>
                    <div class="form-group">
                        <div class="custom-file">
                            <label>Image</label>
                            <input type="file" class="form-control" name="qualimg" >
                            <label class="custom-file-input">Choose File</label>
                        </div>
                    </div>
                    <img src="{{ asset('assets/img/'.$qualification->qualimg) }}" width="70px" height="70px" alt="Image">
                </div>
                <!-- /.card-body -->
