        ...
        <div class="row">
          ...
          <div class="col-md-12" style="padding-right: 250px">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="{{ url('viewact/'.$activity->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('GET')
                <div class="card-body">
                <div class="form-group">
                    ...
                    <img src="{{ asset('assets/img/'.$activity->actimg) }}" width="200px" height="200px" alt="Image">
