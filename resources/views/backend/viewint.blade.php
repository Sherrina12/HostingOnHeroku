        ...
        <div class="row">
          ...
          <div class="col-md-12" style="padding-right: 250px">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="{{ url('viewint/'.$interest->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('GET')
                <div class="card-body">
                <div class="form-group">
                    <label for="id"> No : </label>
                    <input type="text" class="form-control" name="id" value="{{ $interest->id}}">
                </div>
                    <div class="form-group">

                            <label>Image</label><br>
                    <img src="{{ asset('assets/img/'.$interest->intimg) }}" width="200px" height="200px" alt="Image">
